...
const NavLinksSm = () => {
  ...
  return (
    <div className='w-full items-center mt-2 border-t-2 border-t-black-100 absolute left-0 p-3 bg-deepPurple text-white z-10'>
      <div className='mx-2'>
        {
          category.map((item, index) => {
            return (
              <div className='flex mb-2' key={index}>
                {iconIndex[index]}
                <button className='mx-1 font-semibold text-lg'>{item}</button>
              </div>         
            )       
          })
        }
